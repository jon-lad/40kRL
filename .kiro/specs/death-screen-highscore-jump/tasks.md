...
- [x] 1. Write tests for the pure view-decision seam (TDD — before implementation)
  - [x]* 1.1 Create `Tests/test_death_score_view.cpp` with unit (example) tests for `placementNumber` and `computeDeathScoreView`
  ...
  - [x]* 1.2 Write property test for ranked opens on the containing page
  ...
  - [x]* 1.3 Write property test for highlight iff ranked in-range
  ...
  - [x]* 1.4 Write property test for unranked opens at the first page
  ...
  - [x]* 1.5 Write property test for initial page always a valid page index
  ...
  - [x]* 1.6 Write property test for placement number is 1-based
  ...
  - [x]* 1.7 Write property test for determinism / no side effects
...
- [x] 2. Implement the pure view-decision seam (make tests pass)
  - [x] 2.1 Add `DeathScoreView`, `computeDeathScoreView`, and `placementNumber` to the high-score module
